            ...
            <div key={item.id}
              ...
              <div className="flex items-start justify-between flex-wrap gap-4">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-cyan-400/10 text-cyan-400
                ...
                <div className="flex flex-col items-end gap-3">
                  ...
                  {nextStatus[item.status] && (
                    <button
                      ...
                      className="bg-cyan-400 hover:bg-cyan-300 disabled:opacity-50
                                 text-gray-950 font-medium text-sm px-4 py-2
                  ...
                  <button
                    ...
                    className="text-red-400 hover:text-red-300 text-sm
                               hover:bg-red-400/10 px-3 py-1.5 rounded-lg
                               transition"
                  >
                    Cancel Order
                  </button>
